...
when os.OS == "windows" do foreign import glfw { "glfw3.lib", "system:user32.lib", "system:gdi32.lib", "system:shell32.lib" };
...
foreign glfw {
    ...
    WindowShouldClose  :: proc(window: Window_Handle) -> b32 ---;
    ...
    JoystickIsGamepad      :: proc(jid: i32) -> b32 ---;
